...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Risacoin " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"risacointools.com", "localhost"},// Ihaveto add IP after
    {NULL, NULL}
};

static const char *strTestNetDNSSeed[][2] = {
    {"risacointools.com", "testnet-seed.risacointools.com"},
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Risacoin is probably already running."), addrBind.ToString().c_str());
        else
